...
namespace FirstARPG.StateMachine
{
    ...
    public class PlayerHangingState : PlayerBaseState
    {
        ...
        private readonly int HangingHash = Animator.StringToHash("ANI_Hanging");
        ...
        public override void Enter()
        {
            ...
            stateMachine.transform.position = closestPoint -
                                              (stateMachine.LedgeDetector.transform.position -
        ...
        public override void Tick(float deltaTime)
        {
            ...
            {
                stateMachine.SwitchState(new PlayerPullUpState(stateMachine,closestPoint));
            }
            else if (stateMachine.InputReader.MovementValue.y < 0f)
            {
                stateMachine.Controller.Move(Vector3.zero);
                stateMachine.CurVelocity = Vector3.zero;
